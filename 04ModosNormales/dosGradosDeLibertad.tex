...
\begin{figure}[h]
\centering{}
\includegraphics[clip,scale=0.65]{moleculaT.png}
\end{figure}
\begin{enumerate}
...
\begin{figure}[h]
	\centering{}
	\includegraphics[clip,scale=0.65]{moleculaT_fijo_libre}
\end{figure} 
\end{enumerate}
...
\begin{figure}[h]
\centering{}\includegraphics[clip,scale=0.45]{resortes_acoplados}
\end{figure}
\begin{enumerate}
