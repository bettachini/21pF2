...
Dos partículas de ídentica masa $m$ están unidas a paredes con resortes dispuestos verticalmente de longitud natural $l_0$ ($l_0< L/2$) y constante elástica $k_1$, y con otros dispuestos horizontalmente de $l_0= 0$ (\emph{slinkies}) y constante $k_2$.
