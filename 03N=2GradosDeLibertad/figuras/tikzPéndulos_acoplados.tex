...
\dimline[extension start length=-0.25, extension end length=-0.25]{(-2.5,-1.3)}{(2.5,-1.3)}{\(l_o\)}; % cota resorte izq 2 
...
\fill [pattern = north east lines] (screen) rectangle +(6,0.25); % pared superior pattern
